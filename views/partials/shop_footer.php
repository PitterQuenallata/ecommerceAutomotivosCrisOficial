            ...
            <div class="newsletter__area">
                <div class="newsletter__inner d-flex justify-content-between align-items-center">
                    <div class="newsletter__content">
                        <h2 class="newsletter__title">Suscribete <span class="text__secondary">Informacion</span></h2>
                        <p class="newsletter__desc">No esperes más y escribe una cita inteligente y lógica aquí. Es muy fácil.</p>
                    </div>
                    <div class="newsletter__subscribe">
                        <form class="newsletter__subscribe--form" action="#">
                            <label>
                                <input class="newsletter__subscribe--input" placeholder="Ingrese su email" type="text">
                            </label>
                            <button class="newsletter__subscribe--button" type="submit">Suscribirse</button>
                        </form>   
                    </div> 
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-lg-5 col-md-10">
                        <div class="footer__widget">
                            <h2 class="footer__widget--title">Sobre nosotros<button class="footer__widget--button" aria-label="footer widget button"></button>
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                            </h2>
                            <div class="footer__widget--inner">
                                <p class="footer__widget--desc">Somos una tienda boliviana dedicada a la venta de repuestos de vehículos de todas las marcas. Con años de experiencia en el mercado, ofrecemos productos de alta calidad y un servicio al cliente excepcional. Nos enorgullece ser el lugar de confianza para los conductores bolivianos que buscan mantener sus vehículos en óptimas condiciones.</p>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="footer__widget">
                            <h2 class="footer__widget--title ">Mi cuenta<button class="footer__widget--button" aria-label="footer widget button"></button>
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                            </h2>
                            <ul class="footer__widget--menu footer__widget--inner">
                                ...
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="cart.html">Carro de compras</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="cart.html">Ingresar</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="login.html">Registrar</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="checkout.html">Pagar</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-5">
                        <div class="footer__widget">
                            <h2 class="footer__widget--title ">Recuerdanos<button class="footer__widget--button" aria-label="footer widget button"></button>
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                            </h2>
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="contactos">Contactanos</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="about">Sobre nosotros</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="wishlist">Lista de deseos</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="privacy-policy">Politica de privacidad</a></li>
            ...
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    <div class="footer__logo">
                        <a class="footer__logo--link" href="index.html"><img src="<?php BASE_URL?>public/assets/ecommerce/logoHoriz.png"></a>
                    </div>
                    <p class="copyright__content"><span class="text__secondary">© 2024</span> por <a class="copyright__content--link" target="_blank" >Pitter Quenallata</a> .  Reservado todos los derechos</p>
                    <div class="footer__payment">
                        <img src="<?php BASE_URL?>public/assets/shop/img/icon/payment-img.webp" alt="payment-img">
                    </div>
                </div>
            </div>
        </div>
