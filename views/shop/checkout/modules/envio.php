  ...
  <div class="main checkout__mian">
    <form class="needs-validation" novalidate>
          ...
          <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                <div class="checkout__input--list">
                  ...
                  <input class="checkout__input--field border-radius-5" placeholder="Carnet" id="ciEnvio" value="<?= htmlspecialchars($usuario["nit_ci_cliente"]) ?>" type="text" required>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                <div class="checkout__input--list">
                  ...
                  <input class="checkout__input--field border-radius-5" placeholder="Celular" id="celularEnvio" value="<?= htmlspecialchars($usuario["telefono_cliente"]) ?>" type="text" required>
                  <div class="invalid-feedback">Por favor, ingresa tu número de celular.</div>                
                </div>
              </div>

              <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                <div class="checkout__input--list">
                  <label class="checkout__input--label mb-2" for="dirrecion">Direccion<span class="checkout__input--label__star">*</span></label>
                  <input class="checkout__input--field border-radius-5" placeholder="Direccion" id="direccionEnvio" value="<?= htmlspecialchars($usuario["direccion_cliente"]) ?>" type="text" required>
              ...
              <div class="col-lg-4 mb-5">
                <div class="checkout__input--list">
                  ...
                  <div class="checkout__input--select select">
                    <select class="checkout__input--select__field border-radius-5" id="departamento" onchange="actualizarProvincias()" required>
              ...
              <div class="col-lg-4 mb-5">
                <div class="checkout__input--list">
                  ...
                  <div class="checkout__input--select select">
                    <select class="checkout__input--select__field border-radius-5" id="provincia" onchange="actualizarSucursales()" required>
              ...
              <div class="col-lg-4 mb-5">
                <div class="checkout__input--list">
                  ...
                  <div class="checkout__input--select select">
                    <select class="checkout__input--select__field border-radius-5" id="sucursal" required>
      ...
      <div class="checkout__content--step__footer d-flex align-items-center">
        <a class="continue__shipping--btn primary__btn border-radius-5" id="continuar-compra" type="submit">Continuar con la compra</a>
